...
description: Analiza el estado del AI Engineering Workflow en el proyecto actual. Lee workflow-state.json, el último handoff, evidencia de sonar y security, y produce un diagnóstico del estado del ciclo SDD. Usar antes de retomar trabajo para entender dónde se quedó.
---
